...
export const MacbookScroll = ({
	...
	// Reduce total travel to shrink overall animation footprint
	const translateAdjusted = useTransform(scrollYProgress, [0, 1], [0, 1000]);
	...
	return (
		...
		>
			...
			<Lid src={src} scaleX={scaleX} scaleY={scaleY} rotate={rotate} translate={translateAdjusted} />
